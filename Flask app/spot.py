...
def get_songs():
    ...
    return render_template('home.html', preten=preten, radio = radio, ringo = ringo, batman = batman, preten_num=preten_num, radio_num = radio_num, ringo_num = ringo_num, batman_num = batman_num )
